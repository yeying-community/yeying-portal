    ...
    <div class="mx-auto pt-10 sm:pt-16 lg:pt-40">
        <div class="text-center">
          <div class="text-center flex justify-center">
            <div class="text-balance max-w-4xl font-puhuiMedium opacity-85 text-4xl tracking-tight text-gray-900 sm:text-6xl line_height sm:line_height2 leading-snug	">Build any smart <span class="blue-color">web3</span> application freely</div>
          </div>
