  ...
  <div class="detail">
    ...
    <div class="part">
      ...
      <el-row class="part-row">
        ...
        <el-col :span="8" :xs="24">绑定服务代号: {{detailInfo.serviceCodes&&detailInfo.serviceCodes.join(",")}}</el-col>
        <el-col :span="8" :xs="24">访问地址(URL): {{detailInfo.location}}</el-col>
      </el-row>
      <el-row class="part-row">
        <el-col :span="24">代码包: <a href="detailInfo.codeaaa" style="color:rgba(22, 119, 255, 1)">{{detailInfo.codeaaa}}</a></el-col>
      </el-row>
      <el-row class="part-row">
