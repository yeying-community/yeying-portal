...
class $identity {
  constructor() {
    this.manager = new YeYing.IdentityManager()
    console.log("identity:",this.manager)
  }
  async create(email, telephone, password) {
    ...
    const identity = await this.manager.createNewIdentity(metadata, blockAddress, extend, password)
    return identity
  }
}
